 ...
 */
export function copyDeDenegacion(causa, modulo) {
    if (causa === "sin-modulo") {
        return {
            titulo: `Este espacio no tiene ${modulo} activo`,
            cuerpo: `Te equivocaste de espacio, no de producto. Si este es el espacio ` +
    ...
    return {
        ...
        cuerpo: `${modulo} está limitado mientras dura el piloto, o tu cuenta no tiene ` +
...
function haciaElHub(hubOrigen, ruta) {
    try {
 ...
 */
export function htmlDeDenegacion(opciones) {
