 ...
 */
export declare function copyDeDenegacion(causa: CausaDeDenegacion, modulo: string): CopyDeDenegacion;
 ...
 */
export declare function htmlDeDenegacion(opciones: OpcionesDeDenegacion): string;
